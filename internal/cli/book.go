...
func newBookPlaceCmd(opt *Options) *cobra.Command {
	...
	var cardExternalID, phone, licensePlate, licensePlateState string
	...
	cmd.Flags().StringVar(&phone, "phone", "", "E.164 phone for checkout item_context (default from /users/me/)")
